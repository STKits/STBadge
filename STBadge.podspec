...
Pod::Spec.new do |s|
  s.name             = 'STBadge'
  s.version          = '0.1.0'
  s.summary          = 'A short description of STBadge.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/cnjsyyb/STBadge'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'cnjsyyb' => 'cnjsyyb@163.com' }
  s.source           = { :git => 'https://github.com/cnjsyyb/STBadge.git', :tag => s.version.to_s }
